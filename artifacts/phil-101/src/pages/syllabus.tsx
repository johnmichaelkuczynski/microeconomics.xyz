...
export default function Syllabus() {
  ...
  return (
    <PageShell
      title="Syllabus"
      intro="Everything you need to know about how Microeconomics 101 is taught, graded, and supported."
    >
      ...
      <Section title="Course information">
        <DefList
          items={[
            ["Course", "ECON 101 — Introduction to Microeconomics"],
      ...
      <Section title="Course description">
        <p className="text-stone-800">
          Microeconomics 101 introduces students to the central concepts and
          debates of modern microeconomics: opportunity cost and the
          production possibilities frontier, supply and demand, elasticity,
          consumer choice, production and cost curves, market structures
          (perfect competition through monopoly), externalities, game
          theory, labor markets, public goods, asymmetric information, and
          international trade at the firm-and-worker level. Through
          readings, structured discussion, and short writing assignments,
          students learn to apply microeconomic models to real markets and
          evaluate policy arguments using evidence from specific episodes.
        </p>
      </Section>
      ...
      <Section title="Course learning outcomes">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-stone-800">
          <li>
            Distinguish accounting from opportunity costs and use the
            production possibilities frontier to reason about scarcity,
            efficiency, and trade-offs.
          </li>
          <li>
            Use the supply-and-demand framework, elasticity, and consumer-
            and producer-surplus analysis to evaluate price controls,
            taxes, and other interventions.
          </li>
          <li>
            Compare market structures (perfect competition, monopolistic
            competition, oligopoly, monopoly) and apply them to specific
            industries.
          </li>
          <li>
            Analyze externalities, public goods, asymmetric information,
            and other sources of market failure, and evaluate Pigouvian,
            regulatory, and Coasean responses.
          </li>
          <li>
            Apply game theory to strategic interactions in oligopoly,
            cartels, bargaining, and treaty design.
          </li>
          <li>
            Apply microeconomic reasoning to a contemporary market or
            policy question in a short argumentative term paper.
          </li>
        </ol>
      </Section>
