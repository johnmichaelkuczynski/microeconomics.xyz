...
export default function StartHere() {
  ...
  const login = useLogin({
    mutation: {
      onSuccess: async () => {
        toast.success("Welcome to Microeconomics 101!");
  ...
  return (
    <PageShell
      title="Welcome to Microeconomics 101"
      intro="An introduction to the major questions of microeconomics — how individuals, firms, and markets allocate scarce resources, and the policies that shape those choices."
    >
      <Card>
        <CardHeader>
        ...
        <CardContent className="prose prose-stone max-w-none">
          <p>
            <strong>Microeconomics 101: Introduction to Microeconomics</strong>{" "}
            is a fully online, asynchronous college-level course. Over 13
            modules you will work through the core concepts of modern
            microeconomics — opportunity cost, supply and demand,
            elasticity, consumer choice, production and costs, market
            structures, externalities, game theory, labor markets, public
            goods, asymmetric information, and international trade — using
            both standard models and real markets. The course culminates
            in a short term paper applying microeconomic reasoning to a
            contemporary market or policy question.
          </p>
          <p>
      ...
      <Card>
        ...
        <CardContent className="prose prose-stone max-w-none">
          <p>
            Dr. Margaret Hsu has taught introductory microeconomics at the
